...
/***/ "./resources/laravel/js/rpmMonthlyServices.js":
/*!****************************************************!*\
  !*** ./resources/laravel/js/rpmMonthlyServices.js ***!
  \****************************************************/
...
var onMonthlyService = function onMonthlyService(formObj, fields, response) {
...
var onMonthlyServiceCall = function onMonthlyServiceCall(formObj, fields, response) {
...
var onMonthlyServiceWithin = function onMonthlyServiceWithin(formObj, fields, response) {
  if (response.status == 200) {
...
var onMonthlyServiceOutOf = function onMonthlyServiceOutOf(formObj, fields, response) {
  if (response.status == 200) {
...
var init = function init() {
  ...
  form.ajaxForm("monthlyservice", onMonthlyService, function () {
    ...
    $("form[name='monthlyservice'] input[name='end_time']").val(timer_paused); // $("input[name='start_time']").val(timer_start);
  ...
  form.ajaxForm("monthly_service_form", onMonthlyServiceCall, function () {
    ...
    $("form[name='monthly_service_form'] input[name='end_time']").val(timer_paused); // $("input[name='start_time']").val(timer_start);
  ...
  form.ajaxForm("monthly_within_guideline_form", onMonthlyServiceWithin, function () {
    ...
    $("form[name='monthly_within_guideline_form'] input[name='end_time']").val(timer_paused); // $("input[name='start_time']").val(timer_start);
  ...
  form.ajaxForm("monthly_out_of_guidelines", onMonthlyServiceOutOf, function () {
    ...
    $("form[name='monthly_out_of_guidelines'] input[name='end_time']").val(timer_paused); // $("input[name='start_time']").val(timer_start);
  ...
  $("#monthly_services_nxt_txt_date_div").hide(); // $("#office_range_div").hide();
  ...
  $("#review_data").change(function () {
    if ($("#review_data").val() == 1) {
      ...
      $("#record_details").hide();
      $("#summary").hide(); // var c1 = $('#trialtext').html();    
      // alert($(c1).text()); 
  ...
  $("#text").click(function () {
    ...
    $("#summary_not_recorded_text").show();
    $("#summary_not_recorded_call").hide();
    $("#contact_via").val("text"); // getTextScripts('content_title');
  });
  ...
  $("#call_content_title").change(function () {
    var content_title = $(this).val(); //$("#temp_id").val(content_title);
  ...
  $("#office_range").click(function () {
    ...
    $("#emergency_range_div").hide(); //  $('#emergency_range_div').html('');
  ...
  $("#emergency_range").click(function () {
    ...
    $("#out_of_guidelines").show();
    $("#questionnaireButtons").show();
    $("#office_range_div").hide(); // $('#office_range_div').html('');
  ...
  $("form[name='monthly_within_guideline_form'] #within_guideline_content_title option:last").attr("selected", "selected").change(); // $("form[name='monthly_out_of_guidelines'] #within_guideline_content_title option:last").attr("selected", "selected").change();
  ...
  $(".summarize-details").click(function () {
    alert("summerize changes"); //  $(".step3").trigger('click');
...
/***/ 8:
/*!**********************************************************!*\
  !*** multi ./resources/laravel/js/rpmMonthlyServices.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/ashwinim/public_html/rcaregit/resources/laravel/js/rpmMonthlyServices.js */"./resources/laravel/js/rpmMonthlyServices.js");
