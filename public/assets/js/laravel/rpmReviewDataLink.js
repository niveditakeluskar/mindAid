...
var onCaremanagerNotes = function onCaremanagerNotes(formObj, fields, response) {
  if (response.status == 200) {
    ...
    table.DataTable().ajax.reload(); // $("#timer_end").val(timer_paused);
  }
};
...
module.exports = __webpack_require__(/*! /home/ashwinim/public_html/rcaregit/resources/laravel/js/rpmReviewDataLink.js */"./resources/laravel/js/rpmReviewDataLink.js");
