...
var onCallStatus = function onCallStatus(formObj, fields, response) {
  if (response.status == 200) {
    ...
    $(".form_start_time").val(response.data.form_start_time); // util.getDataCalender($("#patient_id").val(), $("form[name='callstatus_form'] input[name='module_id']").val());
...
module.exports = __webpack_require__(/*! /home/nivedita/public_html/rcaregit/resources/laravel/js/ccmcpdcommonJS.js */"./resources/laravel/js/ccmcpdcommonJS.js");
