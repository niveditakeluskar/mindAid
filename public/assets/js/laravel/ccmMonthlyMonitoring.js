    ...
    for (var key in result) {
      if (key == 'callwrapup_form') {
        ...
        if (result[key] != null && typeof result[key] != "undefined" && result[key] != "") {
          ...
          var checklist_data = result[key]["static"]['checklist_data']; // console.log(checklist_data);
...
var init = function init() {
  ...
  util.getDistinctDiagnosisCountForBubble(patient_id); // starts here
...
module.exports = __webpack_require__(/*! /var/www/html/rcarerepo/rcaregit/resources/laravel/js/ccmMonthlyMonitoring.js */"./resources/laravel/js/ccmMonthlyMonitoring.js");
