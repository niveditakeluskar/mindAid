...
var onSaveChecklist = function onSaveChecklist(formObj, fields, response) {
  ...
  if (response.status == 200) {
    ...
    util.totalTimeSpentByCM();
    $("#error_msg1").html('');
    $('#check_hidden').val(response.data); // var text = '<button type="button" class="close" data-dismiss="alert">x</button><strong>Enrollment checklist saved successfully! </strong><span id="text"></span>';
...
module.exports = __webpack_require__(/*! /home/ashwinim/public_html/rcaregit/resources/laravel/js/patientEnrollment.js */"./resources/laravel/js/patientEnrollment.js");
