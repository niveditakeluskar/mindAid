...
namespace RCare\RCareAdmin\AdminPackages\Protocol\src\Providers;
...
class ProtocolServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->make('RCare\RCareAdmin\AdminPackages\Protocol\src\Http\Controllers\ProtocolController');
    }
