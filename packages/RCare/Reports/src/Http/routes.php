...
Route::prefix('reports')->group(function () {
    ...
    Route::middleware(["auth", "web"])->group(function () {
        Route::get('/task-status-report-new', "RCare\Reports\Http\Controllers\TaskStatusReportController@TaskStatusReportList")->name('task.status.report');
       ...
       'RCare\Reports\Http\Controllers\CallActivityPractiseWiseCountReportController@CAPWCReport');
        ...
        //TaskStatusReport  
        Route::get(
            '/task-status-report-search/{caremanagerid}/{practicesgrp}/{practiceid}/{patient}/{taskstatus}/{fromdate}/{todate}/{activedeactivestatus}/{score}/{timeoption}/{time}',
            'RCare\Reports\Http\Controllers\TaskStatusReportController@TaskStatusReportSearch'
        )->name('task.status.search.report');
        ...
        Route::get(
            '/countcallAdditionalServiceListSearch/{practicesgrp}/{practices}/{provider}/{fromdate1}/{todate1}',
            'RCare\Reports\Http\Controllers\CallActivityPractiseWiseCountReportController@CAPWCReportSearch'
        )->name('call.Activity.Service.search.report');

        Route::get(
            "/callActivityServiceListSearch/{practices}/{provider}/{practicesgrp}/{patient}/{fromdate1}/{todate1}",
            "RCare\Reports\Http\Controllers\CallActivityPractiseWiseCountReportController@callActivityServiceListSearch"
        )->name("callActivityServiceListSearch");
