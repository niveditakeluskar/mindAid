...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Enrolled Patient's Details</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
            ...
            <div class="card-body">
                ...
                <div class="col-md-2 form-group mb-3">  
                    ...
                    <div class="col-md-1 form-group mb-3">
                       <button type="button" id="enrolledsearchbutton" class="btn btn-primary mt-4">Search</button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="enrolled_patient_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
       ...
       var getEnrolledPatientList = function(practice = null,activedeactivestatus=null) {
           ...
           // debugger;
            ...
            if(activedeactivestatus==''){activedeactivestatus=null;}
                ...
                var url1 = "/reports/enrolled/search/"+practice+'/'+activedeactivestatus;  
              //  console.log(url);
                var table1 = util.renderDataTable('enrolled_patient_list', url1, columns, "{{ asset('') }}");
...
$('#enrolledsearchbutton').click(function(){
