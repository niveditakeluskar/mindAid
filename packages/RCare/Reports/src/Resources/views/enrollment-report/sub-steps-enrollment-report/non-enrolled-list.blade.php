...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Non-Enrolled Patient's Details</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="card text-left">   
            <div class="card-body">
                <form id="non_enrolled_form" name="non_enrolled_form"  action ="">
                @csrf
                <div class="form-row">
                    ...
                    <div class="col-md-1 form-group mb-3">
                       <button type="button" id="nonenrolledsearchbutton" class="btn btn-primary mt-4">Search</button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="nonenrolled_patient_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
...
@section('page-js')
 ...
 <script type="text/javascript">
       var getNonEnrolledPatientList = function(practice = null) {
            var columns =  [
           ...
           // debugger;
            if(practice=='')
            {
                ...
                var url1 = "/reports/non-enrolled/search/"+practice;
              //  console.log(url);
                var table1 = util.renderDataTable('nonenrolled_patient_list', url1, columns, "{{ asset('') }}");
              
        }
        $(document).ready(function() {
          
           getNonEnrolledPatientList();
...
$('#nonenrolledsearchbutton').click(function(){
   
    var practice=$('#practicesid').val();
    console.log(practice+" test");
     getNonEnrolledPatientList(practice);
