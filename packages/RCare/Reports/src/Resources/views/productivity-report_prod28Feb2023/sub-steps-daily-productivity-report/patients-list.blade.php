...
@section('page-js')
 ...
 <script type="text/javascript">
       var getProductivityPatientsList = function(practice=null) {
            var columns =  [
            ...
            // if(caremanager==''){ caremanager=null; }
               ...
               var url ="/reports/productivity-patients/"+practice;
              //  console.log(url);
...
$('#search-patients').click(function(){
    ...
    if(practice_id==''){
        practice='null';
         ...
         practice = $('#practices').val();
    }
     getProductivityPatientsList(practice);
});
