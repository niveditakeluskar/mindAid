...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Daily Billable Patients List</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
...
var getProductivityBillablePatientList = function(practice=null,caremanager=null,modules=null,fromdate=null,todate=null) {
    var columns =  [
    ...
    // var url ="/reports/productivity-daily-billable-patients/"+practice+'/'+caremanager+'/'+modules+'/'+fromdate+'/'+todate;
    // console.log(url);
     var url ="/reports/productivity-daily-billable-patients/"+practice+'/'+caremanager+'/'+modules+'/'+fromdate+'/'+todate;
...
$('#search-billable-patient').click(function(){
  ...
  var fromdate ="null"; 
  var todate ="null";  
    getProductivityBillablePatientList(practice,caremanager,modules,fromdate,todate);
});
