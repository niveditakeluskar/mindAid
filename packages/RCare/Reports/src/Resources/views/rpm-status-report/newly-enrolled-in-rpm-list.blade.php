...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Newly Enrolled In RPM Details</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-1 form-group mb-3">
                       <button type="button" id="enrolledrpmsearchbutton" class="btn btn-primary mt-4">Search</button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="enrolled_in_rpm_patient_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
...
@section('page-js')
 ...
 <script type="text/javascript">
       var getEnrolledPatientList = function(practice = null) {  
            var columns =  [
           ...
           // debugger;
            if(practice=='')
            {
                ...
                var url1 = "/reports/newlyenrolledInRPM/search/"+practice;
              //  console.log(url);
                var table1 = util.renderDataTable('enrolled_in_rpm_patient_list', url1, columns, "{{ asset('') }}");
...
$('#enrolledrpmsearchbutton').click(function(){
