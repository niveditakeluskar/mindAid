...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Readings Not Received Last Three Days In RPM Details</h4>  
        </div>
    </div>
    <!-- ss -->             
</div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-1 form-group mb-3">
                       <button type="button" id="rpmsearchbutton" class="btn btn-primary mt-4">Search</button>
                    </div>
                </div>
                </form>
            </div>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="rpm_patient_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
...
@section('page-js')
 ...
 <script type="text/javascript">
       var getPatientList = function(practice = null) {  
            var columns =  [
           ...
           // debugger;
            if(practice=='')
            {
                ...
                var url1 = "/reports/noreadingslastthreedaysInRPM/search/"+practice;
              //  console.log(url);
                var table1 = util.renderDataTable('rpm_patient_list', url1, columns, "{{ asset('') }}");
              
        }
        $(document).ready(function() {

            var selectedpractices = '<?php echo $selectedpractices; ?>';
            $('#practicesid').val(selectedpractices).trigger('change'); 
            
            getPatientList(selectedpractices);  
