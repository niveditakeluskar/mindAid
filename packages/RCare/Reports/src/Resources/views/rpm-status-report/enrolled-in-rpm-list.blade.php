...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Enrolled In RPM Details</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-1 form-group mb-3">
                       <button type="button" id="enrolledinrpmsearchbutton" class="btn btn-primary mt-4">Search</button>
                    </div>
                </div>
                </form>
            </div>
       ...
       var getEnrolledPatientList = function(practice = null) {
           ...
           // debugger;
            ...
            // if(activedeactivestatus==''){activedeactivestatus=null;}
                ...
                var url1 = "/reports/enrolledInRPM/search/"+practice;
              //  console.log(url);
...
$('#enrolledinrpmsearchbutton').click(function(){
