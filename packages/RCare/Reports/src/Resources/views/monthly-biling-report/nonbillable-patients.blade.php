...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Total Patient's NonBillable Details in CCM</h4>  
        </div>
    </div>
    <!-- ss -->             
</div>
...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="card text-left">   
            <div class="card-body">
                <form id="total_billablepatient_details_form" name="total_billablepatient_details_form"  action ="">
                @csrf
                <div class="form-row">
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="total_nonbillablepatients_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
       ...
       var getTotalNonBillablePatientList = function(practice = null) {
           ...
           // debugger;
            if(practice=='')
            {
                ...
                var url1 = "/reports/totalnonbillablepatients/search/"+practice;
              //  console.log(url);
                var table1 = util.renderDataTable('total_nonbillablepatients_list', url1, columns, "{{ asset('') }}");
...
$('#totalpatientssearchbutton').click(function(){
    ...
    getTotalNonBillablePatientList(practice);
