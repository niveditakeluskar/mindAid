...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Total Patient's Billable Details in RPM</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="total_billablepatientsrpm_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
...
@section('page-js')
 ...
 <script type="text/javascript">
       var getTotalBillablePatientList = function(practice = null) {
            var columns =  [
           ...
           // debugger;
            if(practice=='')
            {
                ...
                var url1 = "/reports/totalbillablepatientsrpm/search/"+practice;
              //  console.log(url);
                var table1 = util.renderDataTable('total_billablepatientsrpm_list', url1, columns, "{{ asset('') }}");
              
        }
        $(document).ready(function() {
          
           getTotalBillablePatientList(); 
...
$('#totalpatientssearchbutton').click(function(){
    ...
    console.log(practice+" test");
     getTotalBillablePatientList(practice);
