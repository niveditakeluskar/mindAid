...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Total Patient's Billable Details in CCM</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
        ...
        <div class="card text-left">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="total_billablepatients_list" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
       ...
       var getTotalBillablePatientList = function(practice = null) {
           ...
           // debugger;
            if(practice=='')
            {
                ...
                var url1 = "/reports/totalbillablepatients/search/"+practice;
              //  console.log(url);
                var table1 = util.renderDataTable('total_billablepatients_list', url1, columns, "{{ asset('') }}");
