...
<script type="text/javascript">
    var table1="";
    var caremanagerPerformance = function(caremanagerid=null,fromdate=null,todate=null,activedeactivestatus=null) {     
        var columns =  [   
        ...
        var url = "care-manager-performance-report/search/"+caremanagerid+'/'+fromdate+'/'+todate+'/'+activedeactivestatus;
    ...
    $("#month-search").click(function(){
        ...
        caremanagerPerformance(caremanagerid,fromdate,todate,activedeactivestatus);
    });
