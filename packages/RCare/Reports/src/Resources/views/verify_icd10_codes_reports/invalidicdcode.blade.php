<!-- <div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Non Verify code</h4>
        </div>
    </div>            
</div>
...
<div>
        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">     
                <div class="card-body">
                    ...
                    <form id="ctt_report_form1" name="ctt_report_form1" method="post" action ="">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-2 form-group mb-3">
                                <label for="practicename">Practice</label>
                                @selectpracticespcp("practices", ["id" => "practices1", "class" => "select2"])  
                            
                            </div>
                            <div class="col-md-2 form-group mb-3">
                                <label for="practicename">Diagnosis Condition</label>
                                @selectdiagnosiscondition("diagnosis", ["id" => "diagnosis_condition1", "class" => "select2"])  
                            </div>
                        
                            <div class="col-md-1 form-group mb-3">
                                <button type="button" class="btn btn-primary mt-4" id="invalidcttsearchbutton">Search</button>
                            </div>

                            <div class="col-md-1 form-group mb-3">
                                <button type="reset" class="btn btn-primary mt-4" id="invalidcttresetbutton">Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="row mb-4">
            ...
            <div class="card text-left">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="verify_report1" class="display datatable table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
        ...
        <!-- The Modal -->
        <div class="modal" id="patientdetailsicdmodel1">  
                        ...
                        <div class="row mb-4">   
                            ...
                            <div class="card text-left">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="verify_report_child1" class="display datatable table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th width ="10px">Sr No.</th>
