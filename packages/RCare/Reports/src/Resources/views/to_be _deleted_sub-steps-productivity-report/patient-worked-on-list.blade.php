...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Worked On Patient's Details</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                     <div class="col-md-2 form-group mb-3">
                        ...
                        @selectpractices("practices", ["id" => "practice_id","class" => "select2"])
                    </div>
        ...
        <div class="card text-left">
            <div class="card-body"> 
                ...
                <div class="table-responsive">
                    <table id="Productivity-Patient-Worked-On-List" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
...
var getProductivityPatientWorkedOnList = function(practice=null,caremanager=null,fromdate=null,todate=null) {
    var columns =  [
    ...
    var url ="/reports/productivity-patient-worked-on/"+practice+'/'+caremanager+'/'+fromdate+'/'+todate;
    // console.log(url);
    util.renderDataTable('Productivity-Patient-Worked-On-List', url, columns, "{{ asset('') }}");
}
...
$('#search-patient-workedon').click(function(){
    ...
    getProductivityPatientWorkedOnList(practice,caremanager,fromdate,todate);
});

// $('#practices').change(function(){+'/'+caremanager+'/'+fromdate+'/'+todate
