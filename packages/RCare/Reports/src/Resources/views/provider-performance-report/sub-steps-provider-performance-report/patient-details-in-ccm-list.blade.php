...
<div class="breadcrusmb">
    <div class="row">
        <div class="col-md-11">
            <h4 class="card-title mb-3">Provider Performance Patients Details In CCM</h4>
        </div>
    </div>
    <!-- ss -->             
</div>
...
@section('page-js')
 ...
 <script type="text/javascript">
       var getCCMPatientList = function(practice = null,provider = null) {
            var columns =  [
           ...
           // debugger;
             ...
             if(provider=='')
            {
                ...
                var url1 = "/reports/get-data-patient-details-in-ccm/"+practice+"/"+provider;
              //  console.log(url);
        ...
        $(document).ready(function() {
           ...
           getCCMPatientList(practiceid,providerid);
