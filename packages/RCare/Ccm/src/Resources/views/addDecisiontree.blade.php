...
<a href="#"><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#question_div">Question 1</button>
<div class="appendedQuestion" id="question_div" >
    ...
    <div class="form-group" id="dropdown">
        <div class="row">
            ...
            <select class="custom-select col-md-7" name="question[q][1][answerFormat]" id="answerFormat"> 
    ...
    <div class="form-group" id="labels">
        ...
        <div>
            <i class="queSubRemove i-Remove" id="removeButton" style="color: #f44336;  font-size: 22px;"></i>
        </div> 
    </div>
</div>
</a>
