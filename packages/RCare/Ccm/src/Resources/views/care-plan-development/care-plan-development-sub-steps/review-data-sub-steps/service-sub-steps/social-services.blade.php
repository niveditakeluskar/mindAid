<form id="review_service_social_form" name="review_service_social_form" action="{{ route("care.plan.development.services") }}" method="post">
...
<div class="row">
    <div class="col-12">
        <div class="table-responsive">
            <table id="social-review-services-list" class="display datatable table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                <thead >
                    <tr> 
                        <th>Sr</th>
                        <th>Types</th>
