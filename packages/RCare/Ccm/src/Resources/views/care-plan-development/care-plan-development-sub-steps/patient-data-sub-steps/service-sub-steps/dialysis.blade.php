<form id="service_dialysis_form" name="service_dialysis_form" action="{{ route("care.plan.development.services") }}" method="post">
	  <div class="alert alert-success" id="success-alert" style="display: none;">
        <button type="button" class="close" data-dismiss="alert">x</button> 
        <strong> Dialysis data saved successfully! </strong><span id="text"></span>
    </div> 
    <div class="form-row col-md-12">
      ...
      <?php
        ...
        $step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Service-Dialysis');
      ?>
...
<div class="row">
    <div class="col-12">
        <div class="table-responsive">
            <table id="dialysis-services-list" class="display table table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                <thead >
                    <tr> 
                        <th>Sr</th>
                        <th>Types</th>
