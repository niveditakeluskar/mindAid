<form id="allergy_insect_form" name="allergy_insect_form" action="{{ route("save.allergy.data")}}" method="post">    
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Allergy-Insect');
		?>
    ...
    <input type="hidden" name="form_name" value="allergy_insect_form">
     ...
     <div class="col-md-12 form-group mt-3">
       ...
       <label class="checkbox" onclick="ccmcpdcommonJS.hideShowNKDAMsg('insectcount','insectmsg');" class="noAllergiesLbl" style="z-index: 1;">No Known Insect Allergies
        ...
        <div id="insectmsg" style="color:red; display:none">Please delete all data from below table to enable checkbox!</div>  
...
<div class="row">
    <div class="col-12">
        <div class="table-responsive">
            <table id="insect-list" class="display table table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                <thead>
                    <tr> 
                        <th>Sr</th>
                        <th>Specify</th>
