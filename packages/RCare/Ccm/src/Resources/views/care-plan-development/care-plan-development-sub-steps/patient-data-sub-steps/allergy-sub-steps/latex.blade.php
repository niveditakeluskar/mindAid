<form id="allergy_latex_form" name="allergy_latex_form" action="{{ route("save.allergy.data")}}" method="post">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Allergy-Latex');
		?>
     ...
     <div class="col-md-12 form-group mt-3"> 
        ...
        <label class="checkbox" onclick="ccmcpdcommonJS.hideShowNKDAMsg('latexcount','latexmsg');" class="noAllergiesLbl" style="z-index: 1;">No Known Latex Allergies
            ...
            <div id="latexmsg" style="color:red; display:none">Please delete all data from below table to enable checkbox!</div>  
