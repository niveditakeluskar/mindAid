<div class="row">
	<div class="col-lg-12 mb-3">
		...
		<div class="card">
			<form  id="homeservice_form" name="homeservice_form" action="{{ route("monthly.monitoring.call.hippa") }}" method="post"> 
				<div class=" card-body">
					@csrf
					<?php
						...
						$stage_id = getFormStageId($module_id, $submodule_id, 'Home Services');
					?>
                    ...
                    <input type="hidden" name="hippa_stage_id" value="{{ getFormStageId($module_id , $submodule_id, 'Hippa') }}" />
					<input type="hidden" name="step_id" value="0">
					<input type="hidden" name="billable" value ="{{$patient_providers->practice['billable']}}">
					<div class="row">
						<div class="col-md-8 text">
							<div class="alert alert-success" id="success-alert" style="display: none;">
								<!-- <button type="button" class="close" data-dismiss="alert">x</button> -->
								<strong>Verification data saved successfully! </strong>
							</div>
							<div class="alert alert-warning" id="schedule-alert" style="display: none;">
								<!-- <button type="button" class="close" data-dismiss="alert">x</button> -->
								<strong>Verification Date Schedule successfully! </strong>
							</div>
					...
					<div id="home_service_yes_div" class="row">
						<div class="form-group col-md-12 text1">
							...
							<div class="invalid-feedback"></div>
							<span id ="resons_error" style="width: 100%; margin-top: 0.25rem; font-size: 80%; color: #f44336;"></span>
						...
						<div class="form-group col-md-12">
							...
							<div class="invalid-feedback" id="home_service_ends_error"></div>
						</div>
