<form id="allergy_food_form" name="allergy_food_form" action="{{ route("save.allergy.data") }}" method="post">  
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'allergy-Food');
		?>
    ...
    <input type="hidden" name="form_name" value="allergy_food_form">
     ...
     <div class="col-md-12 form-group mt-3">
       ...
       <label class="checkbox" onclick="ccmcpdcommonJS.hideShowNKDAMsg('foodcount','foodmsg');" class="noAllergiesLbl" style="z-index: 1;">No Known Food Allergies
        ...
        <div id="foodmsg" style="color:red; display:none">Please delete all data from below table to enable checkbox!</div>  
