<form id="review_family_care_giver_form" name="review_family_care_giver_form" action="{{route("care.plan.development.family.care.giver")}}" method="post">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Review-Family-Care-Giver');
		...
		<input type="hidden" name="form_name" value="review_family_care_giver_form">
		...
		<div class="mc-footer">
			<div class="row">
				...
				<!-- onclick="window.location.assign('#step-4')" -->
					<button type="submit" class="btn  btn-primary m-1" id="save_review_family_care_giver_form">Save</button>
				</div>
			</div>
		</div>
	</div>
