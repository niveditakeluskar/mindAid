<form id="review_allergy_pet_related_form" name="review_allergy_pet_related_form" action="{{route("save.allergy.data") }}" method="post">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Review-Allergy-Pet-Related');
        ...
        <input type="hidden" name="form_name" value="review_allergy_pet_related_form">
     ...
     <div class="col-md-12 form-group mt-3">
        ...
        <label class="checkbox" onclick="ccmcpdcommonJS.hideShowNKDAMsg('reviewpetrelatedcount','reviewpetrelatedmsg');" class="noAllergiesLbl" style="z-index: 1;">No Known Pet-Related Allergies
            ...
            <div id="reviewpetrelatedmsg" style="color:red; display:none">Please delete all data from below table to enable checkbox!</div>  
            <span class="checkmark"></span>  
        </label>
        <input type = "hidden" id ="reviewpetrelatedcount" value =""> 
      </div>
		...
		<div class="mc-footer">
			<div class="row">
				...
				<!-- onclick="window.location.assign('#step-4')" -->
					<button type="submit" class="btn  btn-primary m-1" id="save_review_allergy_pet_related_form">Save</button>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
    <div class="col-12">
        <div class="table-responsive">
            <table id="review-pet-related-list" class="display datatable table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                <thead>
                    <tr> 
                        <th>Sr</th>
                        <th>Specify</th>
