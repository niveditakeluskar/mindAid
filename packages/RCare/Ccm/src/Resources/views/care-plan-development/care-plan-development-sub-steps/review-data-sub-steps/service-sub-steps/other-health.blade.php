<form id="review_service_other_health_form" name="review_service_other_health_form" action="{{ route("care.plan.development.services") }}" method="post">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Review-Service-Other-Health');
        ...
        <input type="hidden" name="form_name" value="review_service_other_health_form">
		...
		<div class="mc-footer">
			<div class="row">
				...
				<!-- onclick="window.location.assign('#step-4')" -->
					<button type="submit" class="btn  btn-primary m-1" id="save_review_service_other_health_form">Save</button>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-12">
		<div class="table-responsive">
			<table id="other-health-review-services-list" class="display datatable table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
				<thead >
					<tr> 
						<th>Sr</th>
						<th>Types</th>
