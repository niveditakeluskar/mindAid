<form id="allergy_enviromental_form" name="allergy_enviromental_form" action="{{ route("save.allergy.data") }}" method="post">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Allergy-Enviromental');
		?>
    ...
    <input type="hidden" name="form_name" value="allergy_enviromental_form">
     ...
     <input type="hidden" name="billable" value ="<?php if(isset($patient_enroll_date[0]->finalize_cpd) && $patient_enroll_date[0]->finalize_cpd == 0 && $billable == 0 && $enroll_in_rpm == 0){echo 0;}else{echo 1;} ?>">
      ...
      <div class="col-md-12 form-group mt-3">
       ...
       <label class="checkbox" onclick="ccmcpdcommonJS.hideShowNKDAMsg('enviromentalcount','enviromentalmsg');" class="noAllergiesLbl" style="z-index: 1;">No Known Enviromental Allergies
        ...
        <div id="enviromentalmsg" style="color:red; display:none">Please delete all data from below table to enable checkbox!</div>  
