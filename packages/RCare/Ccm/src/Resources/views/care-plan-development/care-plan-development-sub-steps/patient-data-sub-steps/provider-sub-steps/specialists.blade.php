<form id="provider_specialists_form" name="provider_specialists_form" action="{{route("care.plan.development.provider")}}" method="post"> 
  ...
  <div class="form-row col-md-12"> 
    ...
    <?php
      ...
      $step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Provider-Specialists');
    ?>
    ...
    <input type="hidden" name="form_name" value="provider_specialists_form">
    ...
    <div class="mc-footer">
      <div class="row">
        ...
        <!-- onclick="window.location.assign('#step-4')" -->
          <!-- <button type="button" class="btn  btn-info m-1 float-left" id="Add_provider_specialists_form">Additional</button> -->
          <button type="submit" class="btn  btn-primary m-1" id="save_provider_specialists_form">Save</button>
        </div>
      </div>
    </div>
  </div>
...
<!--  <a class="btn btn-success btn-sm " href="javascript:void(0)" id="addUser"> Add Role</a>    -->            
  ...
  <div class="table-responsive">
      <table id="Specialists-list" class="display table table-striped table-bordered" style="width:100%">
      <thead>
          <tr>
