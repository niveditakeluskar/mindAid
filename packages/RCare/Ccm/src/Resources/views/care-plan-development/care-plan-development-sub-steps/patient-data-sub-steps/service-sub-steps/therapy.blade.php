<form id="service_therapy_form" name="service_therapy_form" action="{{ route("care.plan.development.services") }}" method="post">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Service-Therapy');
		?>
...
<div class="row">
    <div class="col-12">
        <div class="table-responsive">
            <table id="therapy-services-list" class="display table table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                <thead >
                    <tr> 
                        <th>Sr</th>
                        <th>Types</th>
