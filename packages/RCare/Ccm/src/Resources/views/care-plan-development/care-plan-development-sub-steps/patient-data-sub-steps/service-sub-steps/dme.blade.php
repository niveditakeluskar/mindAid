<form id="service_dme_form" name="service_dme_form" action="{{ route("care.plan.development.services") }}" method="post">
<div class="alert alert-success" id="success-alert" style="display: none;">
	...
	<div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Service-Dme');
		?>
