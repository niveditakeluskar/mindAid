                  ...
                  <table id="diagnosis-list" class="display table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th width="80px" data-toggle="tooltip" data-placement="top" data-original-title="when Comments were saved or ICD10 code was changed" title="when Comments were saved or ICD10 code was changed">Last Modified On</th>
