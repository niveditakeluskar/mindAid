<form id="review_service_therapy_form" name="review_service_therapy_form" action="{{ route("care.plan.development.services") }}" method="post">
  <div class="form-row col-md-12">
		...
		<?php
			...
			$step_id      = getFormStepId($module_id, $submodule_id, $stage_id, 'Review-Service-Therapy');
        ...
        <input type="hidden" name="form_name" value="review_service_therapy_form">
		...
		<div class="mc-footer">
			<div class="row">
				<div class="col-lg-12 text-right">
					<button type="submit" class="btn  btn-primary m-1" id="review_save_service_therapy_form">Save</button>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
    <div class="col-12">
        <div class="table-responsive">
            <table id="therapy-review-services-list" class="display datatable table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                <thead >
                    <tr> 
                        <th>Sr</th>
                        <th>Types</th>
