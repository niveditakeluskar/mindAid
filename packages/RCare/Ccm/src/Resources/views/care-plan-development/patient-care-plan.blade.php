...
<div class="card">       
    <div class="card-body" style="margin: -45px -45px -0px -45px"> 
        ...
        <div class="form-row" style="padding-top: 15px">
          ...
          <tr class="col5"> 
          <td colspan="2"><b>Enrolled On : </b><?php
                    $enroll_date="";
             ...
             <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10" id="ID16">
                           ...
                           <table width = 100%>
                            <tr class="vital_data"><td><b>Date: </b>
                           <?php $date = explode(" ", $rec->date); ?>
                            {{$date[0]}}  
                                ...
                                <td><b>Pain Level:</b> {{$rec->pain_level}}</td>
                                </tr> 
                            </table>
                            @endif
...
<div style="float: right;">
  ...
  Signature - 
  <b><?php //dd($electronic_sign) ?>
    {{ isset($electronic_sign[0]->f_name)? $electronic_sign[0]->f_name.' '.$electronic_sign[0]->l_name:' '}} <br></b>
