            ...
            <div class="card-body">
                ...
                <form class="" method="post" action="{{ route('SaveQuestionnaire) }}"> 
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-1"><span class="cerror" style="display:none;color:red">Content Name Requred</span></div>
                            <div class="col-md-2 "><label>Content Type</label></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1"><span class="merror" style="display:none;color:red">Select module</Select></span></div>
            ...
            <div class="question_div" id="demo">
                        <div class="form-group" id = "question">
                            ...
                            <input type="hidden" value="0" id="subcounter">
                                    ...
                                    <input type="text" name="DT[qs][q]"  placeholder = "Enter Question" class="form-control col-md-3 qt"> 
