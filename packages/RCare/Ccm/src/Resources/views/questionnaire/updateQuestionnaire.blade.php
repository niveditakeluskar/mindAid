                ...
                <div class="row">
                    ...
                    <select class="custom-select col-md-3" name="sub_module" id="sub_module">
                         @foreach($sub_service as $key)
                            <option value="{{ $key->id }}" <?php if($data->component_id == $key->id){ echo 'selected'; } ?>>{{ $key->sub_services }}</option>
                         @endforeach
                    </select>
            ...
            <div class="question_div">
                <div class="form-group" id = "question">
                    <div class="row">
                            ...
                            <input type="text" class="form-control col-md-3" name="question[q][<?php echo $number; ?>][questionTitle]" value="{{$value->questionTitle}}">
                ...
                <div class="form-group" id="dropdown">
                    <div class="row">
                        ...
                        <option value="1"<?php if ($value->answerFormat==1){echo 'selected';} ?>>Dropdown</option>
                        <option value="2"<?php if ($value->answerFormat==2){echo 'selected';} ?>>Textbox</option>
                        <option value="3"<?php if ($value->answerFormat==3){echo 'selected';} ?>>Radio</option>
                        <option value="4"<?php if ($value->answerFormat==4){echo 'selected';} ?>>Checkbox</option>
                        <option value="5"<?php if ($value->answerFormat==5){echo 'selected';} ?>>Textarea</option>
                        </select>
                    </div>
                </div>
                <div class="form-group" id="labels">
                    <div class="row labels_container" id="labels_container_{{$number}}">
                        ...
                        <div class="col-md-1 "> <i id="add{{$number}}" type="button" onclick="addLabels(this);" class="add i-Add" style="color: #2cb8ea;  font-size: 22px;"></i></div>
                        <div class="new-text-div col-md-10">
                        
                        @foreach($value->label as $labels)
                        <div class="row form-group rm">
                            <input type="textbox" name="question[q][<?php echo $number; ?>][label][]" id="label" class="form-control col-md-4" value="<?php echo $labels; ?>"/><i class="remove col-md-1 offset-md-1 i-Remove" style="color: #f44336;  font-size: 22px;"></i> <br>                    
                        </div>
                         @endforeach
   ...
   function addLabels(obj){   
       ...
       //    alert(parentId);
          ...
          var count=parseInt($('#counter').val());
           $("#"+parentId).children(".new-text-div").append( $('<div class="row form-group rm"><input type="textbox" name="question[q]['+ count + '][label][]" id="label" class="form-control col-md-4 lab"/> <i type="button" class="remove col-md-1 offset-md-1 i-Remove" style="color: #f44336;  font-size: 22px;"></i></div>'));
