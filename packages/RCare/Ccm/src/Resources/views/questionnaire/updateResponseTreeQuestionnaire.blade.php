...
<div class="col-md-12 mb-4">
   <div class="card text-left">
      <div class="card-body">
         <form class="" method="post" action="{{ route('edit-ccm-Decision') }}">
            @csrf
                                ...
                                <div class="form-group" id="dropdown">
                                    <div class="row">
                                        ...
                                        <select class="custom-select col-md-7" name="{{$af_label}}" id="answerSubFormat_<?php echo $ids; ?>" onchange="getChild(this)"> 
                                            ...
                                            <option value="{{ 4 }}" <?php if($treeObj->$i->qs->$j->AF==4){echo 'selected';} ?>>Checkbox</option>
                        ...
                        <div class="form-group" id="dropdown">
                            <div class="row">
                                ...
                                <select class="custom-select col-md-3" name="DT[qs][AF]" id="answerFormat" onchange="getChild(this)"> 
                                    ...
                                    <option value="{{ 4 }}" <?php if ($queData->question->qs->AF==4){echo 'selected';} ?>>Checkbox</option>
