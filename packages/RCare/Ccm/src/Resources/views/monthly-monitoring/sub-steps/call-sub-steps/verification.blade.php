					...
					<div class="row">
						<div class="col-md-8 text">
							...
							<div class="alert alert-warning" id="schedule-alert" style="display: none;">
								<!-- <button type="button" class="close" data-dismiss="alert">x</button> -->
								<strong>Verification services Date Schedule successfully! </strong>
							</div>
							<div class="alert alert-danger" id="eligibility-alert" style="display: none;">
								<!-- <button type="button" class="close" data-dismiss="alert">x</button> -->
								<!-- Non Eligible Script!  -->
								<strong>Verification Services data saved successfully</strong>
							</div>
							...
							<div class="mb-3">
								...
								<div class="invalid-feedback" id="verification-invalid-feedback"></div>
							</div>
