...
<div class="tree">
    <ul>
		<li class="question_tree" id="question_tree_1">
			<a href="#"><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Question 1</button>
            <div class="question_div" id="demo">
                        ...
                        <div class="form-group" id="dropdown">
                            <div class="row">
                                ...
                                <select class="custom-select col-md-3" name="DT[qs][AF]" id="answerFormat"> 
    ...
    <div class="mc-footer">
        <div class="row">
            <div class="col-lg-12 text-right">
                <button type="submit" name="tree" class="btn  btn-primary m-1" >Save</button>
            </div>
        </div>
    </div>
</div>
