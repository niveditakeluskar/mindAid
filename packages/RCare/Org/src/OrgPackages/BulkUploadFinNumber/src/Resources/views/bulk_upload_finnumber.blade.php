...
<div class="breadcrusmb">
    <div class="row">
		<div class="col-md-11">
		   <h4 class="card-title mb-3">Bulk Upload Fin Number</h4>
		</div>
    </div>            
</div> 
        ...
        <div class="card text-left">
            <div class="card-body">                    
                ...
                <!-- <div class="container mt-5"> -->
                    <form action="javascript:void(0)" method="post" name ="FinNumberForm" id="FinNumberForm" enctype="multipart/form-data">
...
$(document).ready(function () {
  $('#FinNumberForm').submit(function(e) {
        e.preventDefault();
        var formName = $(`form[name="FinNumberForm"]`);
        formName.find(".is-invalid").removeClass("is-invalid");
        formName.find(".invalid-feedback").html("");
        var formData = new FormData(this);
        $.ajax({
          type:'POST',
          url: "{{ url('org/upload-fin-number')}}",
          data: formData,
          cache:false,
          contentType: false,
          processData: false,
          success: (data) => {
            ...
            if(data == 1){
              ...
              var fields = form.getFields('FinNumberForm');
