...
Route::prefix('org')->group(function () {
    Route::middleware(["auth", "web"])->group(function () {
        ...
        Route::get('/ajax/holiday/populateForm/{patientId}','RCare\Org\OrgPackages\Holiday\src\Http\Controllers\holidayController@populateHolidayData')->name("ajax.populate.holiday.data");
