...
class PracticesController1sep22bk extends Controller {
    ...
    // public function uploadDocsFile(Request $request){ //practicesDocsAddRequest
    ...
    //         return redirect('/org/org-practice')->with('message', 'The Document Updated Succesfully!');
    //     }else{  
    ...
    //         //return "add";
    //         // return redirect()->back()->with('success', 'Your message has been sent successfully!');
    //         return redirect('/org/org-practice')->with('message', 'The success message!');
    //     }
