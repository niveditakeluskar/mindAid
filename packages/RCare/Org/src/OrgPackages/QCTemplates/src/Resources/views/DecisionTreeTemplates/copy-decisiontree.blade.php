...
$stage_id = getFormStagesId($module_id, 'General Question');
?>
<div class="breadcrusmb">

  <div class="row">
                <div class="col-md-11">
                   <h4 class="card-title mb-3">Copy Decision Tree  Template</h4>
                </div>
...
$(document).ready(function(){        
    ...
    $("[name='from_stage_code']").on("change", function () {
        ...
        if(parseInt($(this).val()) > 0){
            util.updateTemplateList(module_id, parseInt($(this).val()), 6, $("#list_of_template"));
        }else{
            util.updateTemplateList(module_id, -1, 6, $("#list_of_template"));
        }
