            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" name="active_deactive_form" id="active_deactive_form">
                        ...
                        <input type="hidden" name="uid" class="patient_id"/>
                        <input type="text" name="timearr[form_start_time]" class="timearr form_start_time">
    ...
    <div id="additional-device" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="patient_add_device_form" id="patient_add_device_form">
                        @csrf
                        <input type="hidden" name="patient_id" class="patient_id"/>
                        <input type="hidden" name="uid" class="patient_id"/>
                        <input type="hidden"   name="timearr[form_start_time]" class="timearr form_start_time">
                        ...
                        ?>
                        <input type="hidden" name="stage_id" value="{{ $stage_id }}" />
                        <div class="alert alert-success-additional-device" id="additional-device" style="display: none;">
                    ...
                    <div class="tab-content" id="myIconTabContent">
                        <div class="tab-pane show active" id="Patient-Threshold_1" role="tabpanel" aria-labelledby="call-icon-tab">
                            ...
                            <form name="patient_threshold_form" id="patient_threshold_form">
                                ...
                                value="<?php if (isset($PatientDevices[0]->device_code)) {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="part_of_research_study" class="form-control forms-element">
                                        <?php if (isset($research_study['static']['part_of_research_study'])) {
