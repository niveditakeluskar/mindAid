                    ...
                    <li class="{{ request()->is('uikits/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon mr-2 i-Suitcase"></i> Registration
                    ...
                    <li class="{{ request()->is('extrakits/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon i-Library mr-2"></i> AWV
                                </a><input type="checkbox" id="drop-2">
                                <ul>
                                    <li class="nav-item">
                    ...
                    <li class="{{ request()->is('apps/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon mr-2 i-Computer-Secure"></i> TCM
                                </a><input type="checkbox" id="drop-2">
                                <ul>
                    ...
                    <li class="{{ request()->is('forms/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon mr-2 i-File-Clipboard-File--Text"></i> CCM
                                </a><input type="checkbox" id="drop-2">
                                <ul>
                    ...
                    <li class="{{ request()->is('charts/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon mr-2 i-Bar-Chart-5"></i> RPM
                                </a><input type="checkbox" id="drop-2">
                                <ul>
					...
					<li class="{{ request()->is('charts/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon mr-2 i-Bar-Chart-5"></i> Reports
                                </a><input type="checkbox" id="drop-2">
                                <ul>
					...
					<li class="{{ request()->is('forms/*') ? 'active' : '' }}">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <a href="#">
                                    <i class="nav-icon mr-2 i-File-Clipboard-File--Text"></i> Administration
                                </a><input type="checkbox" id="drop-2">
                                <ul>
