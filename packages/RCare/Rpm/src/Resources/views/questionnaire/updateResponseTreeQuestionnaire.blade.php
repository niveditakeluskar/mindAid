...
<div class="col-md-12 mb-4">
   <div class="card text-left">
      <div class="card-body">
         <form class="" method="post" action="{{ route('edit-rpm-Decision') }}">
            @csrf
            ...
            function renderTree($treeObj,$lab,$val,$tree_id){
                ...
                for($i=1; $i<= $optCount; $i++) {
                   ...
                   $label_str = str_replace("[q]","",$lab);
                    ...
                    ?>
                    <li class="lrm<?php echo $id; ?>"><a href="#" onclick="return false;"><div class="row form-group rm"><input type="hidden" value="<?php if(property_exists($treeObj->$i, 'qs') ){echo count((array)$treeObj->$i->qs);}else{echo 0;}  ?>" id="qscount<?php echo $id; ?>">
            ...
            <i class="col-md-1 offset-md-1 i-Add  as" id="addSubQuestion" onclick='addSubQuestion(<?php echo $id ; ?>,"<?php echo $label ;?>","<?php echo $tree_id."".$val ; ?>")'    style="color: #2cb8ea;  font-size: 22px;" ></i> </div></a>
                    <?php 
                                ...
                                <div class="form-group" >
                                    <div class="row">
                                        <?php if(property_exists($treeObj->$i->qs->$j, 'opt')){$qoptcount = count((array)$treeObj->$i->qs->$j->opt);} else{ $qoptcount=0;} ?>
                                            ...
                                            <input type="text" name="{{$question_label}}" class="form-control col-md-3 qt" value="{{$treeObj->$i->qs->$j->q}}">
                                ...
                                <div class="form-group" id="dropdown">
                                    <div class="row">
                                        ...
                                        <select class="custom-select col-md-7" name="{{$af_label}}" id="answerSubFormat_<?php echo $ids; ?>" onchange="getChild(this)"> 
                                            <option value="{{ 1 }}" <?php if($treeObj->$i->qs->$j->AF==1){echo 'selected';} ?>>Dropdown</option>
		...
		<li class="question_tree" id="question_tree_1">
            ...
            <div class="question_div" id="demo">
                        <div class="form-group" id = "question">
                            <div class="row">
                            <input type="hidden" value="{{count((array)$queData->question->qs->opt)}}" id="lbcount">    
                            <input type="hidden" value="0" id="count">
                            <input type="hidden" value="0" id="subcounter">
                                    <label class="col-md-2">Question 1</label>
                                    
                                    <input type="text" name="DT[qs][q]" class="form-control col-md-3 qt" value="{{$queData->question->qs->q}}">
                                    <!--i class="i-Add col-md-2" id="addQuestion" style="color: #2cb8ea;  font-size: 22px;"></i-->
                            </div>   
                        </div>
                        ...
                        <div class="form-group" id="dropdown">
                            <div class="row">
                                ...
                                <select class="custom-select col-md-3" name="DT[qs][AF]" id="answerFormat" onchange="getChild(this)"> 
                                    <option value="{{ 1 }}" <?php if ($queData->question->qs->AF==1){echo 'selected';} ?>>Dropdown</option>
            ...
            <?php
                          ...
                          // echo $queData->question->qs->q; 
                           ...
                           //echo "<pre>";
                           renderTree($queData->question->qs->opt,'DT[qs][q]','1','question_tree_');
