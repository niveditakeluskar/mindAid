    ...
    <div class="col-md-12 mb-4">
        <div class="card text-left">
            <div class="card-body">
                ...
                <form class="" method="post" action="{{ route('save-rpm-questionnaire') }}" id="rpm-questionnaire-add"> 
                    @csrf
                    <div class="form-group">
                            <div class="row">
                                <div class="col-md-2"><label>Content Name</label> </div>
                                <input type="text" class="form-control col-md-3" name="content_title" id="content_title" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select col-md-3" name="module" id="module" onchange="get_subservice(this.value);" required>
                            <option value="0">Choose One...</option>
                            @foreach($service as $value)
                            <option value="{{ $value->id }}" <?php if($value->service_name == 'RPM') {echo "selected='selected'";} ?>>{{ $value->service_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="question_div">
                        <div class="form-group" id = "question">
                            ...
                            <input type="hidden" value="0" id="subcounter">
                                    ...
                                    @text("question", ["name" => "question[q][1][questionTitle]", "placeholder" => "Enter Question", "required", "class" => "form-control col-md-3"])
                        ...
                        <div class="form-group" id="dropdown">
                            <div class="row">
                                ...
                                <select class="custom-select col-md-3" name="question[q][1][answerFormat]" id="answerFormat" required> 
...
@section('page-js')
    ...
    <script type="text/javascript">
        if ($("#rpm-questionnaire-add").length > 0) {
