...
<div class="breadcrusmb">
  ...
  <div class="row">
                ...
                <div class="col-md-1">
                 ...
                 <a class="" href="questionnaire"><i class="add-icons i-Blinklist" data-toggle="tooltip" data-placement="top" title="Add Questionnaire Template"></i>&nbsp;<i class="plus-icons i-Add" data-toggle="tooltip" data-placement="top" title="Add Questionnaire Template"></i></a> 
                </div> 
              </div>
   <!-- ss -->             
</div>
