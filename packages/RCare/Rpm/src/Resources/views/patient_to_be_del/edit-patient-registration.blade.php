...
<?php 
 ...
 $patientDemographics = $patientDemographics[0];
 $patientInsurance1 = $patientInsurance[0];
 $patientInsurance2 = $patientInsurance[1];
 $patientPoa = $patientPoa[0];
 $patientProvider = $patientProvider[0];
 $patientContactTime = $patientContactTime[0];
 $patientServices1 = $patientServices[3];
 $patientServices2 = $patientServices[2];
 $patientServices3 = $patientServices[1];
 $patientServices4 = $patientServices[0];
 ?>
					...
					<div class="card-header mb-3">PATIENT REGISTRATION</div>
						<div class="card-body" id="hobby">
							...
							<!-- <form action="" method="post" autocomplete="off" name="patient_registration_form" id="patient_registration_form"> -->
								@csrf
								<input id="patient_id" name="patient_id" type="hidden" value="{{$patients->id}}">
								<input id="practice" type="hidden" value="{{$patientProvider->practice_id}}">
								<input id="physicians" type="hidden" value="{{$patientProvider->provider_id}}">
								<input id="select_gender" type="hidden" value="{{$patientDemographics->gender}}">
								<input id="select_marital_status" type="hidden" value="{{$patientDemographics->marital_status}}">
								<input id="select_state" type="hidden" value="{{$patientAddress->state}}">
								<input id="select_ethnicity" type="hidden" value="{{$patientDemographics->ethnicity}}">
								<input id="select_education" type="hidden" value="{{$patientDemographics->education}}">
								<input id="select_occupation" type="hidden" value="{{$patientDemographics->occupation}}">
								<input id="select_military_status" type="hidden" value="{{$patientDemographics->military_status}}">
								<div class="row">
									<div class="col-6">
								...
								<div class="row">
									<div class="col-4">
										<div class="form-group">
											...
											@text("lname", ["id" => "lname", "class" => "capitalize", "value" => "$patients->lname"])
										</div>
									</div>
									<div class="col-4">
										<div class="form-group">
											<label for="fname">First Name</label>
											@text("fname", ["id" => "fname", "class" => "capitalize", "value" => "$patients->fname"])
										</div>
									</div>
									<div class="col-4">
										<div class="form-group">
											<label for="mname">Middle Name</label>
											@text("mname", ["id" => "mname", "class" => "capitalize", "value" => "$patients->mname"])
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-8 col-md-4">
										<div class="form-group">
											...
											@date("dob", ["value" => "$patients->dob"])
										</div>
									</div>
									<div class="col-4 col-md-2">
										<label>Age</label>
										<input type="number" class="form-control" id="age" name="age" value="{{$patients->age}}" readonly>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											...
											@text("addr1", ["id" => "addr1", "value" => "$patientAddress->add_1"])
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											...
											@text("addr2", ["id" => "addr2", "value" => "$patientAddress->add_2"])
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											@text("city", ["id" => "city", "class" => "capitalize", "value" => "$patientAddress->city"])
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											@text("zip", ["id" => "zip", "value" => "$patientAddress->zipcode"])
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									...
									<div class="form-group col-md-5">
										...
										@text("occupation_description", ["value" => "$patientDemographics->occupation_description"])
									</div>
									<div class="col-md-4 form-group">
								...
								<div data-toggle="buttons">
									<div class="row">
										<div class="col-md-12">
											<div class="input-group form-group">
												...
												@email("email", ["id" => "email", "value" => "$patients->email"])
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											...
											<?php 
												// $res = preg_replace("/[^0-9]/", "", $patients->mob);
												// echo 'mob'.$res;
											?>
											<div class="input-group form-group">
												<div class="input-group-prepend btn-group btn-group-toggle" >
													...
													Preferred
													@input("radio", "preferred_contact", ["id" => "phone-primary-preferred", "value" => "$patients->mob", "data-feedback" => "contact-preferred-feedback"])
													</label>
												</div>
												@text("phone_primary", ["value" => "$patients->mob", "data-inputmask" =>  "'mask': '(999) 999-9999'"])
											</div>
										</div>
										<div class="col-md-6">
											...
											<div class="input-group form-group">
												...
												@text("phone_secondary", ["value" => "$patients->home_number", "data-inputmask" =>  "'mask': '(999) 999-9999'"])
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 form-group">
											<label>Name</label>
											@text("other_contact_name", ["value" => "$patientDemographics->other_contact_name"])
										</div>
										<div class="col-lg-2 col-md-6 form-group">
											<label>Relationship</label>
											@text("other_contact_relationship", ["value" => "$patientDemographics->other_contact_relationship"])
										</div>
										<div class="col-lg-2 col-md-4 form-group">
											<label>Phone Number</label>
											@text("other_contact_phone", ["value" => "$patientDemographics->other_contact_phone_number", "data-inputmask" =>  "'mask': '(999) 999-9999'"])
											
										</div>
										<div class="col-lg-4 col-md-8 form-group">
											<label>Email</label>
											@email("other_contact_email", ["value" => "$patientDemographics->other_contact_email"])
										</div>
									</div>
									<div class="row">
								...
								<div class="row">
									<div class="col-6 div form-group">
										...
										@text("insurance_type[1]", ["value" => "$patientInsurance1->ins_type"])
									</div>
									<div class="col-6 div form-group">
										<label for="insurance_primary_idnum">ID#</label>
										@text("insurance_id[1]", ["value" => "$patientInsurance1->ins_id"])
								...
								<div class="row">
									<div class="col-6 div form-group">
										...
										@text("insurance_type[2]", ["value" => "$patientInsurance2->ins_type"])
									</div>
									<div class="col-6 div form-group">
										<label for="insurance_secondary_idnum">ID#</label>
										@text("insurance_id[2]", ["value" => "$patientInsurance2->ins_id"])
								...
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											...
											@text("emr", ["id" => "emr", "value" => "$patientInsurance1->code"])
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-3 form-group">
										<label>Name</label>
										@text("poa_name", ["value" => "$patientPoa->first_name"])
									</div>
									<div class="col-md-3 form-group">
										<label>Relationship</label>
										@text("poa_relationship", ["value" => "$patientPoa->relationship"])
									</div>
									<div class="col-md-3 form-group">
										<label>Phone Number</label>
										@text("poa_phone", ["value" => "$patientPoa->mobile", "data-inputmask" =>  "'mask': '(999) 999-9999'"])

									</div>
									<div class="col-md-3 form-group">
										<label>Email</label>
										@email("poa_email", ["value" => "$patientPoa->email"])
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-md-3 form-group">
											<input type="checkbox" id="calling_preference" name="calling_preference" value="1" {{ $patients->contact_preference_calling == '1' ? "checked" : ""}}>
											<label for="calling_preference"> Calling</label><br>
											
										</div>
								
								
										<div class="col-md-3 form-group">
											<input type="checkbox" id="sms_preference" name="sms_preference" value="1" {{ $patients->contact_preference_sms == '1' ? "checked" : ""}}>
											<label for="calling_preference"> SMS</label><br>
												
										</div>
							
							
										<div class="col-md-3 form-group">
											<input type="checkbox" id="calling_preference" name="calling_preference" value="1" {{ $patients->contact_preference_email == '1' ? "checked" : ""}}>
											<label for="calling_preference"> Email</label><br>
									
										</div>
							
								
										<div class="col-md-3 form-group">
											<input type="checkbox" id="letter_preference" name="letter_preference" value="1" {{ $patients->contact_preference_letter == '1' ? "checked" : ""}}>
											<label for="calling_preference"> Letter</label><br>
								...
								<div class="row">
									...
									<input type="checkbox" id="enroll-ccm" name="enroll_ccm" value="1" {{  $patientServices1->module_id == 1 ? "checked" : ""}}>
									<label > Enroll in CCM</label><br>
								<!--	@checkbox("Enroll in CCM", "enroll-ccm", "enroll_ccm", "1") -->
								...
								<div class="row">
									<div class="col-md-12 form-group text-right">
									<input type="checkbox" id="enroll-awv" name="enroll_awv" value="2" {{ $patientServices2->module_id == 2  ? "checked" : ""}}>
									<label > Enroll in AWV</label><br>
									<!-- @checkbox("Enroll in AWV", "enroll-awv", "enroll_awv", "2")  -->
								...
								<div class="row">
									<div class="col-md-12 form-group text-right">
									<input type="checkbox" id="enroll-rpm" name="enroll_rpm" value="3" {{ $patientServices3->module_id == 3 ? "checked" : ""}}>
									<label > Enroll in RPM</label><br>
										<!-- @checkbox("Enroll in RPM", "enroll-rpm", "enroll_rpm", "3")  -->
										<!-- <div class="form-check text-right">
								...
								<div class="row">
									<div class="col-md-12 form-group text-right">
									<input type="checkbox" id="enroll-tcm" name="enroll_tcm" value="4" {{ $patientServices4->module_id == 4  ? "checked" : ""}}>
									<label > Enroll in TCM</label><br>
										<!-- @checkbox("Enroll in TCM", "enroll-tcm", "enroll_tcm", "4")  -->
										<!-- <div class="form-check text-right">
								...
								<div class="row">
									...
									<div class="col-12 text-right form-group mb-4"><button type="submit" class="btn btn-primary" id="submit" name="edit">Save</button></div>
								</div>
							</form>
						</div>	
					</div>	
...
$(document).ready(function() {	
        ...
        $.ajax({
            ...
            type: 'get',
            url : '/rpm/ajax/getEditPatientData/'+patient_id,
	...
	patientRegistration.init();
	// $("#practices").trigger('change');
	// $("#practices").change();
		practice_id = $('#practice').val();
		physician_id = $('#physicians').val();
		gender = $('#select_gender').val();
		marital_status = $('#select_marital_status').val();
		state = $('#select_state').val();
		ethnicity = $('#select_ethnicity').val();
		education = $('#select_education').val();
		occupation = $('#select_occupation').val();
		military = $('#select_military_status').val();
		

		$('#practices').val(practice_id);
		$("#practices").trigger('change');
		// $("form select[name=physician_id]").val(physician_id).change();
		// $('#physician option[value="46"]').prop('selected', true).change();
		// $('#physician').find('option[value=46]').attr('selected', 'selected');
		$('#physician').val(physician_id);
		$('[name ="gender"]').val(gender);
		$('[name ="marital_status"]').val(marital_status);
		$('[name ="state"]').val(state);
		$('[name ="ethnicity1"]').val(ethnicity);
		$('[name ="education"]').val(education);
		$('[name ="occupation_status"]').val(occupation);
		$('[name ="military"]').val(military);
