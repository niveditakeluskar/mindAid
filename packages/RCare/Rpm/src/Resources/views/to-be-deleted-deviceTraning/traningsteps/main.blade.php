		...
		<div class="tsf-wizard tsf-wizard-1 top" >    
			<div class="tsf-nav-step">
				<ul class="gsi-step-indicator triangle gsi-style-1  gsi-transition " >
					...
					<li class="device_step1" data-target="step-2">
						<a href="#0">
							<span class="desc">
								<label>Step 2</label>
							</span>
					...
					<li class="device_step2" data-target="step-3">
						<a href="#0">
							<span class="desc">
								<label>Step 3</label>
							</span>
			...
			<div class="tsf-container">
				<form class="tsf-content">
					<div id="step-1" class="tsf-step step-first active">
						@include('Rpm::deviceTraning.traningsteps.patient-device-training-step-1')
					</div>
					<div id="step-2" class="tsf-step step-2">
						@include('Rpm::deviceTraning.traningsteps.patient-device-training-step-2')
					</div>
					<div id="step-3" class="tsf-step step-3">
						@include('Rpm::deviceTraning.traningsteps.patient-device-training-step-3')
					</div>										
				</form>
			</div>
		</div>   
