...
@section('page-js')
    ...
    <script type="text/javascript">
                        ...
                        {data: 'fname',name: 'fname',
                            mRender: function(data, type, full, meta){
                                if(data!='' && data!='NULL' && data!=undefined){
                                    return ["<img src={{asset('assets/images/faces/avatar.png')}} width='50px' class='user-image' />"]+' '+full['fname']+' '+full['mname']+' '+full['lname'];
                                }
                            },
                            orderable: false
                        },
        ...
        var table = util.renderDataTable('patient-list', "{{ route('fetch_patients_monthly_monitoring') }}", columns, "{{ asset('') }}");  
