    ...
    @foreach($patient as $checklist)		
        ...
        <div class="row  mb-4 text-align-center">
            ...
            <div class="col-md-12  mb-4 patient_details">
                ...
                @include('Rpm::patientEnrollment.patient-overview')
                <div class="separator-breadcrumb border-top"></div>          
                <!--Email And Text Section  -->
                @include('Rpm::patientEnrollment.textAndEmail')
                <!-- end -->
                <!--Calling Section  -->         
                @include('Rpm::patientEnrollment.calling')             
                <!-- end --> 
            </div>
        </div>
    @endforeach
...
// text and Email send Ajax
    $("#send").click(function(){
        ...
        $.ajax({
         type:'post', 
         url:"/rpm/patient-enrollment-insert",
         data:{
            _token: '{!! csrf_token() !!}', 
            hidden_id:hidden_id,
...
$("#module_next").click(function(){
 ...
 $("#next_step").click(function(){
    ...
    var template_id       =  $('#script_template_id').val();
    var template_type_id  =  $('#script_template_type_id').val();
