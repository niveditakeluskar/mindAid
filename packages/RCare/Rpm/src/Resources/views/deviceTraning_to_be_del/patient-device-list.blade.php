    ...
    <script type="text/javascript">
        ...
        var getPatientList = function(patient_id = null) {
                                ...
                                { data: 'fname',name: 'fname',
                                    mRender: function(data, type, full, meta){
                                        ...
                                        if(data!='' && data!='NULL' && data!=undefined){
                                            return ["<a href='/rpm/device-training/"+full['id']+"'><img src={{asset('assets/images/faces/avatar.png')}} width='50px' class='user-image' />"]+' '+full['fname']+' '+m_Name+' '+full['lname']+'</a>';
                                        }
                                    },
                                    orderable: false 
                                },
            ...
            if (patient_id == null) {
                ...
                var url ="/rpm/patient-device-details/"+patient_id; 
                console.log(url);
