...
public function patientMonthlyData(Request $request)
{
      ...
      return view('Rpm::timeline_rpm.timeline-activities',compact('patient','patient_id','ob_bp','ob_oxy','ob_weight','ob_glucose','ob_spiro','to_do_list','reminder_rpm_reading'));
} 
