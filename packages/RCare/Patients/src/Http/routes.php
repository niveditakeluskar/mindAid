...
Route::get("/testlink", function(){
            return view('Patients::patient.testunscribed');})->name("test.sub");           
           ...
           Route::get("/text-unsubscribe", function(){ return view('Patients::patient.unsubscribedform'); })->name("text.unsubscribe");
