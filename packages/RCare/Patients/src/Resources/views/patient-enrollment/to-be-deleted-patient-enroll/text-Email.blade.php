                ...
                <!-- use Temlate Content -->
                    <div id="template_content">
                        <div class="row">
                            <div class="col-md-12 form-row" id="contactlist">
                                ...
                                <div class="col-md-8 mb-3">
                                    <select class="forms-element custom-select" name="contact_number" id="contact_number">
                            ...
                            <div class="col-md-12 form-row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    ?>
                                    @selectcontentscript("text_content_title",$text_module_id,$text_submodule_id,$text_stage_id,$text_step_id,["id"=>"text_content_title","class"=>"custom-select"])
                        ...
                        <div class="row" id = "textarea">
                            ...
                            <div class="col-md-8">
                                <textarea name="content_area" class="form-control" id="text_content_area"></textarea> 
                            </div>
							</div>
                        </div>
