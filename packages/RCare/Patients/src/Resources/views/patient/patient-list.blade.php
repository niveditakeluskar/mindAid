                        ...
                        {data: 'fname',name: 'fname',
                            mRender: function(data, type, full, meta){
                                if(data!='' && data!='NULL' && data!=undefined){
                                    return ["<a href='/rpm/enroll-patient-checklist/"+full['id']+"'><img src={{asset('assets/images/faces/avatar.png')}} width='50px' class='user-image' />"]+' '+full['fname']+' '+full['mname']+' '+full['lname']+' '+full['profile_img']+' '+data['profile_img']+'</a>';
                                }
                            },
                            orderable: false
                        },
