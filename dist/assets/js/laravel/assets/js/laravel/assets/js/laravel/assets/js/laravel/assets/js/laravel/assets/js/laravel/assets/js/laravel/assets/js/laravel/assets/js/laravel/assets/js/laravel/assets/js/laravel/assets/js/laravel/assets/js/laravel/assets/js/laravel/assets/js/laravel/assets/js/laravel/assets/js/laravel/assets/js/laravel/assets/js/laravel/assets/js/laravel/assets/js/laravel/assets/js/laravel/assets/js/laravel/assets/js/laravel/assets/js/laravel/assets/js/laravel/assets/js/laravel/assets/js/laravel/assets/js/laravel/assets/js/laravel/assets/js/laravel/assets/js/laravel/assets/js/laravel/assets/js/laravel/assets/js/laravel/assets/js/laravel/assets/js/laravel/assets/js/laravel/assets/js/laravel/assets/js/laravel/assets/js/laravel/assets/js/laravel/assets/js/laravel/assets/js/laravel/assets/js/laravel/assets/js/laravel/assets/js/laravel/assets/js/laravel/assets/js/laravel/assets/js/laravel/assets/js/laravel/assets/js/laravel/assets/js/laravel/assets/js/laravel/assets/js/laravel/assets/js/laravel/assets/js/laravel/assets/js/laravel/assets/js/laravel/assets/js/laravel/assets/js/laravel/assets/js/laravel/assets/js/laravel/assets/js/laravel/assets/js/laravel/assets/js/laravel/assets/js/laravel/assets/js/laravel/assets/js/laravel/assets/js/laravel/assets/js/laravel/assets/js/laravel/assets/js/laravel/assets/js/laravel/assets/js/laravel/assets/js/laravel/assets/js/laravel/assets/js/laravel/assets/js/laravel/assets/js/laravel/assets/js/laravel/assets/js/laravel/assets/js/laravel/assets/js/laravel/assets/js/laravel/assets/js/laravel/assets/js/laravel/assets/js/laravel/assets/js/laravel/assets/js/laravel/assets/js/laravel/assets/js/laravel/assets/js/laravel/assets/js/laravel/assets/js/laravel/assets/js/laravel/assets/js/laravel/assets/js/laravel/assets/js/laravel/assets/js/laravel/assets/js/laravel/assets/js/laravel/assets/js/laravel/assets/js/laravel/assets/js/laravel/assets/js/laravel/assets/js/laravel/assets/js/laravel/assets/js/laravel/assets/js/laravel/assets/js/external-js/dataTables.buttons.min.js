    ...
    var A = function (a) {
        ...
        G = function (a, b) {
           ...
           /* for (var h = b.length, m = [], l = 0, p = 0, r = 0 < h ? f.length / h : 0; p < r; p++) {
               ...
               //rowgrouping changes started   
                var grouped_array_index     = c.grouped_array_index;                     //customised
                ...
                for (var i = 0, ien = no_of_rows; i < ien; i++)
                {
                    ...
                    {
                        rows[j]             = c.format.body( cells[ cellCounter ], i, j, cellNodes[ cellCounter ] );
                        rows_with_nodes[j]  = c.format.body( cellNodes[ cellCounter ], i, j, cells[ cellCounter ] ).outerHTML;
                        cellCounter++;
                    }
                ...
                /******************************************** GROUP DATA *****************************************************/
                var row_array                       = a.rows().nodes();
                var row_data_array                  = a.rows().data();
