    ...
    <div class="modal fade" :class="{ 'open': isOpen }" style="width: 500px; height: 242px; left: 33%; top: 20%;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary float-right" id="logout_yes" data-dismiss="modal" @click.prevent="logout">Yes</button>
                    <button type="button" class="btn btn-default float-left" id="logout_no" data-dismiss="modal" @click.prevent="closeLogoutModal">No</button>
                </div>
            </div>
    </div>
</template>
