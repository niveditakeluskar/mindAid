...
<template>
    <div class="tab-pane fade show active" id="other-health" role="tabpanel" aria-labelledby="other-services-icon-pill">
        <div class="card">  
            ...
            <div class="row">
                <div class="col-12">
                    <AgGridTable :rowData="otherServiceRowData" :columnDefs="columnDefs"/>
    ...
    setup(props) {
        ...
        const fetchPatientOtherServiceList = async () => {
            try {
                ...
                const response = await fetch(`/ccm/care-plan-development-services-list/${props.patientId}/7?mm=${mm}`);
                if (!response.ok) {
