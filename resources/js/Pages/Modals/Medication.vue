                            ...
                            <div class="tab-content" id="myPillTabContent">
                                <div class="tab-pane fade show active" id="medication" role="tabpanel" aria-labelledby="medication-icon-pill">
                                    <div class="card mb-4">
                                        ...
                                        <form id="medications_form" name="medications_form" action="" method="post">
                                            <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            // For example, you can emit an event or call an API
	...
	setup(props) {
        ...
        const maxBlocksInCache = ref(null); let columnDefs = reactive({
            value: [
                {
                    headerName: 'Sr. No.',
                    valueGetter: 'node.rowIndex + 1',
                },
                { headerName: 'Name', field: 'task_notes', filter: true },
                { headerName: 'Description', field: 'task' },
                { headerName: 'Purpose', field: 'tt' },
                { headerName: 'Dosage', field: 'task_time' },
                { headerName: 'Strength', field: 'action'},
                { headerName: 'Frequency', field: 'task_completed_at' },
                { headerName: 'Route', field: 'task_completed_at' },
                { headerName: 'Duration', field: 'task_completed_at' },
                { headerName: 'Pharmacy Name', field: 'task_completed_at' },
                { headerName: 'Pharmacy Phone No', field: 'task_completed_at' },
                {
                ...
                { headerName: 'Last Modified On', field: 'task_completed_at' },
                { headerName: 'Reviewed Data', field: 'task_completed_at' },
                { headerName: 'Action', field: 'task_completed_at' },
            ]
        });
...
.modal {
  ...
  opacity: 0;
  transition: opacity 0.3s ease; /* Add a transition for smoothness */
}
...
.overlay {
  ...
  z-index: 999; /* Place the overlay behind the modal */
  display: none;
