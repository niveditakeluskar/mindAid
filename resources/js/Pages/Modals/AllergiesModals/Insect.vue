   ...
   setup() {
        ...
        let getStageID = async () => {
            try {
                ...
                insectallergiesStageId = response.data.stageID;
                console.log("insectallergiesStageId", insectallergiesStageId);
                getStepID(insectallergiesStageId);
            } catch (error) {
        ...
        let getStepID = async (sid) => {
            try {
                ...
                console.log("insectallergiesStepId", insectallergiesStepId);
            } catch (error) {
        ...
        onMounted(async () => {
            try {
                ...
                console.log("insectallergiesTime time", insectallergiesTime);
            } catch (error) {
