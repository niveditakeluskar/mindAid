            ...
            <form id="allergy_enviromental_form" name="allergy_enviromental_form" @submit.prevent="submitAllergiesForm">
                ...
                <div class="form-row col-md-12">
                    ...
                    <label class="checkbox noAllergiesLbl" style="z-index: 1;">
                        <!-- @click="hideShowNKDAMsg('enviromentalcount','msg');" -->
                    No Known Enviromental Allergies
                    ...
                    <input type = "hidden" id="enviromentalcount" :value="enviromentalAllergiesRowCount">
...
export default {
    ...
    computed: {
        enviromentalAllergiesRowCount() {
        return this.enviromentalAllergiesRowData.length;
        },
    },
    methods: {
        ...
        noAllergiesCheck() {
            if (this.allergyStatus) {
                ...
                var formname = "allergy_enviromental_form";
                this.hideShowNKDAMsg('enviromentalcount', 'msg');
                // alert(formname);
    ...
    setup(props) {
        ...
        const fetchPatientEnviromentalList = async () => {
            try {
                ...
                const response = await fetch(`${baseUrl}/ccm/allergies/${props.patientId}/enviromental?mm=${mm}`);
                if (!response.ok) {
        ...
        let submitAllergiesForm = async () => {
            ...
            try {
                ...
                console.log("in enviromental saveAllergiesResponse", saveAllergiesResponse);
                    ...
                    var form = $("#allergy_enviromental_form")[0];
                    form.reset();
