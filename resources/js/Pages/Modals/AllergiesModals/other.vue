...
<template>
    <div class="tab-pane fade show active" id="other" role="tabpanel" aria-labelledby="other-allergies-icon-pill">
        <div class="card">  
            ...
            <form id="allergy_other_form" name="allergy_other_form" @submit.prevent="submitAllergiesForm">
                ...
                <div class="form-row col-md-12">
                    ...
                    <input type="hidden" name="form_name" value="allergy_other_form">
                    ...
                    <div class="mc-footer">
                        <div class="row">
                            <div class="col-lg-12 text-right">
                                <button type="submit" class="btn  btn-primary m-1" id="save_allergy_other_form">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <table id="other-list" class="display table table-striped table-bordered" style="width:100%; border: 1px solid #00000029;">
                            <thead>
                            <tr> 
                                <th>Sr</th>
                                <th>Specify</th>
...
export default {
   ...
   setup() {
        ...
        let otherallergiesTime = ref(0);

        let submitAllergiesForm = async () => {
            let myForm = document.getElementById('allergy_other_form');
        ...
        let getStageID = async () => {
            try {
                ...
                otherallergiesStageId = response.data.stageID;
                console.log("otherallergiesStageId", otherallergiesStageId);
                getStepID(otherallergiesStageId);
            } catch (error) {
        ...
        let getStepID = async (sid) => {
            try {
                ...
                console.log("otherallergiesStepId", otherallergiesStepId);
            } catch (error) {
        ...
        onMounted(async () => {
            try {
                ...
                console.log("otherallergiesTime time", otherallergiesTime);
            } catch (error) {
