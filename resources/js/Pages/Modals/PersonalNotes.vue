                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <form id="personal_notes_form" name="personal_notes_form" @submit.prevent="submitPersonalNotesForm" :formErrors="formErrors">
                            <input type="text" name="patient_id" id="hidden_id" :value="patientId">
                            <input type="text" name="module_id" id="page_module_id" :value="moduleId">
                            <input type="text" name="component_id" id="page_component_id" :value="componentId">
                            <input type="text" name="stage_id" :value="stageid" />
                            <input type="text" name="id">
                            <input type="text" name="form_name" value="personal_notes_form">
                            <input type="text" id="timer_runing_status" value="0"> 
                            <input type="text" name="timearr[form_start_time]" class="timearr form_start_time" :value="personalnotesTime"> 
                                                 
                            <label>Personal Notes<span class='error'>*</span></label>
                            <textarea name="personal_notes" class="form-control forms-element"></textarea>
            ...
            try {
                ...
                if (response && response.status == 200) {
                    ...
                    setTimeout(() => {
                        ...
                        this.personalnotesTime = document.getElementById('page_landing_times').value;
                    }, 3000);
                }
            } catch (error) {
