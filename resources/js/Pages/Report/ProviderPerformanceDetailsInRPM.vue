  ...
  },
  {
    ...
    cellRenderer: function (params) {
      ...
      return `<div style="display: flex; align-items: center; gap: 3px">
                        <img src=${pImg} class='user-image' style="width: 30px; border-radius: 50%" />
...
const fetchRpmPatientDetailsApiData = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `/reports/get-data-patient-details-in-rpm/${props.practiceId}/${props.providerId}?_=1715324427764`,
      {
        method: "GET",
        headers: {
