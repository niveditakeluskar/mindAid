...
var renderDiagnosisTableData = function () {
	var diagnosisColumns = [
		...
		{
			data: 'review_date', name: 'review_date', "render": function (value) {
				if (value === null || value == undefined || value == "") return "";
				return moment(value).format('MM-DD-YYYY');
			}
		},
...
var getServicesDatatables = function() {
	...
	var url = baseURL + "ccm/care-plan-development-services-list/" + patient_id + '/' + servicetype;
	util.renderDataTable('dme-review-services-list', url, dmeOtherMedicalSuppliesServiceColumns, baseURL);

	// renderDialysiServicesTable();
	var servicetype = $('form[name="review_service_dialysis_form"] .hid').val();
	var url = baseURL + "ccm/care-plan-development-services-list/" + patient_id + '/' + servicetype;
	util.renderDataTable('dialysis-review-services-list', url, homeDialysisTherapySosialServicesColumns, baseURL);

	// renderHomeHealthServicesTable();
	var servicetype = $('form[name="review_service_home_health_form"] .hid').val();
	var url = baseURL + "ccm/care-plan-development-services-list/" + patient_id + '/' + servicetype;
	util.renderDataTable('home-health-review-services-list', url, homeDialysisTherapySosialServicesColumns, baseURL);

	// renderOtherHealthServicesTable();
	var servicetype = $('form[name="review_service_other_health_form"] .hid').val();
	var url = baseURL + "ccm/care-plan-development-services-list/" + patient_id + '/' + servicetype;
	util.renderDataTable('other-health-review-services-list', url, dmeOtherMedicalSuppliesServiceColumns, baseURL);

	// renderMedicalSuppliesServicesTable();
	var servicetype = $('form[name="review_service_medical_supplies_form"] .hid').val();
	var url = baseURL + "ccm/care-plan-development-services-list/" + patient_id + '/' + servicetype;
	util.renderDataTable('medical-supplies-review-services-list', url, dmeOtherMedicalSuppliesServiceColumns, baseURL);

	// renderSocialServicesTable();
	var servicetype = $('form[name="review_service_social_form"] .hid').val();
	var url = baseURL + "ccm/care-plan-development-services-list/" + patient_id + '/' + servicetype;
	util.renderDataTable('social-review-services-list', url, homeDialysisTherapySosialServicesColumns, baseURL);
...
var getAllergiesDatatables = function() {
	...
	var url = baseURL + "ccm/allergies/" + patient_id + "/" + allergytype;
	util.renderDataTable('review-drug-list', url, allergiesColumns, baseURL);
	...
	var url = baseURL + "ccm/allergies/" + patient_id + "/" + allergytype;
	util.renderDataTable('review-food-list', url, allergiesColumns, baseURL);

	// renderinsectTable();
	var allergytype = $('form[name="review_allergy_insect_form"] input[name="allergy_type"]').val();
	var url = baseURL + "ccm/allergies/" + patient_id + "/" + allergytype;
	util.renderDataTable('review-insect-list', url, allergiesColumns, baseURL);

	// renderLatexTable();
	var allergytype = $('form[name="review_allergy_latex_form"] input[name="allergy_type"]').val();
	var url = baseURL + "ccm/allergies/" + patient_id + "/" + allergytype;
	util.renderDataTable('review-latex-list', url, allergiesColumns, baseURL);

	// renderPetRelatedTable();
	var allergytype = $('form[name="review_allergy_pet_related_form"] input[name="allergy_type"]').val();
	var url = baseURL + "ccm/allergies/" + patient_id + "/" + allergytype;
	util.renderDataTable('review-pet-related-list', url, allergiesColumns, baseURL);
