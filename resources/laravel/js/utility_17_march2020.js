...
var updatePhysicianList = function(practiceId, selectElement, selectedPhysician = null) {
    ...
    axios({
        method: "GET",
        url: `/rpm/ajax/practice/${practiceId}/physicians`,
...
var renderDataTable  = function (tabid, url, columnData, assetBaseUrl){
 ...
 */
var updatePatientList = function(practiceId, selectElement, selectedPatients = null) {
    selectElement.html($("<option>").html("Select Patient"));
    if (!practiceId) {
        return;
    }
    axios({
        method: "GET",
        url: `/rpm/ajax/patient/${practiceId}/patient`,
    }).then(function (response) {
        Object.values(response.data).forEach(function(patient) {
            $("<option>").val(patient.id).html(patient.fname+" "+patient.mname+" "+patient.lname+", DOB: "+patient.dob).appendTo(selectElement);
        });
        if (selectedPatients) {
...
var updateStageList = function(subModuleId, selectElement, selectedStages = null) {
    ...
    axios({
        ...
        // url: `/org/ajax/stages/${subModuleId}/stages`,
         url: `/org/ajax/submodule/${subModuleId}/stages`,
    }).then(function (response) {
...
var updateStageCodeList = function(stageId, selectElement, selectedStageCodes = null) {
    ...
    axios({
        ...
        console.lod(JSON.stringify(response));
